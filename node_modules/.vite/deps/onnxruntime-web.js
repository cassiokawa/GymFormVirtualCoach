...
var sn = (i) => Qa(an({}, "__esModule", { value: !0 }), i);
var un;
var ke;
var nr;
var Jd;
...
var ds = O(() => {
	...
	Ro = (i, e) => {
		...
		return u === "RGBA" ? new St("float32", f, [
			1,
			4,
			o,
			t
...
var xs = O(() => {
	...
	gs = (i) => {
		...
		switch (i.location) {
			case "cpu": return new St(i.type, i.data, e);
			case "cpu-pinned": return new St({
				location: "cpu-pinned",
				data: i.data,
				type: i.type,
				dims: e
			});
			case "texture": return new St({
				location: "texture",
				texture: i.texture,
				type: i.type,
				dims: e
			});
			case "gpu-buffer": return new St({
				location: "gpu-buffer",
				gpuBuffer: i.gpuBuffer,
				type: i.type,
				dims: e
			});
			case "ml-tensor": return new St({
				location: "ml-tensor",
				mlTensor: i.mlTensor,
				type: i.type,
				dims: e
			});
			default: throw new Error(`tensorReshape: tensor location ${i.location} is not supported`);
		}
	};
});
var St;
...
var Ps = O(() => {
	...
	Zd = "Training backend could not be resolved. Make sure you're using the correct configuration & WebAssembly files.", hn = class i {
		...
		static async create(e, o) {
			let t = e.evalModel || "", r = e.optimizerModel || "", [s, a] = await ln(o || {});
	...
	Uo = class {
		...
		color(e) {
			switch (e) {
				...
				default: throw new Error(`unsupported severity: ${e}`);
			}
		}
	}, Ls = {
		verbose: 1e3,
...
var Fs = mt((zo) => {
	...
	zo.Guid = function() {
		...
		}, i.validator = /* @__PURE__ */ new RegExp("^[a-z0-9]{8}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{4}-[a-z0-9]{12}$", "i"), i.EMPTY = "00000000-0000-0000-0000-000000000000", i;
	}();
});
function rt(i, e, o) {
...
var qo = O(() => {
	...
	D.toString = function(e) {
		...
		for (var n = zt(Tn(e, 6), this.unsigned), s = this, a = "";;) {
			var u = s.div(n), f = (s.sub(u.mul(n)).toInt() >>> 0).toString(e);
	...
	D.multiply = function(e) {
		...
		if (Et(e) || (e = Qt(e)), Vt) return J(Vt.mul(this.low, this.high, e.low, e.high), Vt.get_high(), this.unsigned);
	...
	D.divide = function(e) {
		...
		if (Vt) {
			...
			return J((this.unsigned ? Vt.div_u : Vt.div_s)(this.low, this.high, e.low, e.high), Vt.get_high(), this.unsigned);
		}
		...
		if (this.unsigned) {
			...
			if (this.eq(Ct)) {
				...
				return t = this.shr(1).div(e).shl(1), t.eq(Zt) ? e.isNegative() ? or : Wo : (r = this.sub(e.mul(t)), n = t.add(r.div(e)), n);
	...
	D.div = D.divide;
	D.modulo = function(e) {
		if (Et(e) || (e = Qt(e)), Vt) return J((this.unsigned ? Vt.rem_u : Vt.rem_s)(this.low, this.high, e.low, e.high), Vt.get_high(), this.unsigned);
...
var wn = O(() => {
	...
	w.int32 = /* @__PURE__ */ new Int32Array(2);
	...
	w.Builder.prototype.startObject = function(i) {
		this.notNested(), this.vtable ??= [], this.vtable_in_use = i;
	...
	w.Builder.prototype.requiredField = function(i, e) {
		var o = this.bb.capacity() - i, t = o - this.bb.readInt32(o);
		if (!(this.bb.readInt16(t + e) != 0)) throw new Error("FlatBuffers: field " + e + " must be set");
	};
	...
	w.ByteBuffer.prototype.__string = function(i, e) {
		...
		for (; r < o;) {
			...
			n < 65536 ? t += String.fromCharCode(n) : (n -= 65536, t += String.fromCharCode((n >> 10) + 55296, (n & 1023) + 56320));
		}
		return t;
	};
...
var Pr = O(() => {
	...
	((e) => {
		...
		((t) => {
			...
			((n) => {
				let r;
				((A) => (A[A.UNDEFINED = 0] = "UNDEFINED", A[A.FLOAT = 1] = "FLOAT", A[A.INT = 2] = "INT", A[A.STRING = 3] = "STRING", A[A.TENSOR = 4] = "TENSOR", A[A.GRAPH = 5] = "GRAPH", A[A.FLOATS = 6] = "FLOATS", A[A.INTS = 7] = "INTS", A[A.STRINGS = 8] = "STRINGS", A[A.TENSORS = 9] = "TENSORS", A[A.GRAPHS = 10] = "GRAPHS", A[A.SPARSE_TENSOR = 11] = "SPARSE_TENSOR", A[A.SPARSE_TENSORS = 12] = "SPARSE_TENSORS"))(n.AttributeType ||= {});
			})(t.fbs ||= {});
		})(e.experimental ||= {});
	})(F ||= {});
	((e) => {
		...
		((t) => {
			...
			((n) => {
				let r;
				((l) => (l[l.UNKNOWN = 0] = "UNKNOWN", l[l.VALUE = 1] = "VALUE", l[l.PARAM = 2] = "PARAM"))(n.DimensionValueType ||= {});
			})(t.fbs ||= {});
		})(e.experimental ||= {});
	})(F ||= {});
	((e) => {
	...
	((e) => {
		...
		((t) => {
			...
			((n) => {
				let r;
				((u) => (u[u.Primitive = 0] = "Primitive", u[u.Fused = 1] = "Fused"))(n.NodeType ||= {});
			})(t.fbs ||= {});
		})(e.experimental ||= {});
	})(F ||= {});
	((e) => {
		...
		((t) => {
			...
			((n) => {
				let r;
				((f) => (f[f.NONE = 0] = "NONE", f[f.tensor_type = 1] = "tensor_type", f[f.sequence_type = 2] = "sequence_type", f[f.map_type = 3] = "map_type"))(n.TypeInfoValue ||= {});
			})(t.fbs ||= {});
		})(e.experimental ||= {});
	})(F ||= {});
	((e) => {
		...
		for (var r = null, n = [], s = 0, a = 0, u; o < t;) {
			...
			switch (a) {
				...
				case 1:
					...
					break;
				case 2: n[s++] = ar[u | l >> 6], n[s++] = ar[l & 63], a = 0;
			}
	...
	function mu(i) {
		function e(o, t) {
			...
			Object.defineProperty(this, "message", { get: function() {
				return o;
			} }), Error.captureStackTrace ? Error.captureStackTrace(this, e) : Object.defineProperty(this, "stack", { value: (/* @__PURE__ */ new Error()).stack || "" }), t && hu(this, t);
		}
	...
	ct.prototype.skipType = function(i) {
		switch (i) {
			...
			case 5:
				this.skip(4);
				break;
			default: throw Error("invalid wire type " + i + " at offset " + this.pos);
		}
		return this;
	};
...
var Y = O(() => {
	...
	Me = class {
		...
		static preprocessInputShapes(e, o) {
			return [e.length === 1 ? [1, e[0]] : e, o.length === 1 ? [o[0], 1] : o];
		}
		...
		static calc(e, o, t, r, n) {
			...
			if (s) {
				...
				if (s.length === 0) u.set([], t(e.get([]), o.get([])));
					...
					let l = new Array(s.length), f = new Array(e.dims.length), p = new Array(o.dims.length), d = 0, y = 0, T = !1, v = !1;
		...
		static tensorDataTypeFromProto(e) {
			switch (e) {
				case ot.onnx.TensorProto.DataType.INT8: return "int8";
				case ot.onnx.TensorProto.DataType.UINT8: return "uint8";
				case ot.onnx.TensorProto.DataType.BOOL: return "bool";
				case ot.onnx.TensorProto.DataType.INT16: return "int16";
				case ot.onnx.TensorProto.DataType.UINT16: return "uint16";
				case ot.onnx.TensorProto.DataType.INT32: return "int32";
				case ot.onnx.TensorProto.DataType.UINT32: return "uint32";
				case ot.onnx.TensorProto.DataType.FLOAT: return "float32";
				case ot.onnx.TensorProto.DataType.DOUBLE: return "float64";
				case ot.onnx.TensorProto.DataType.STRING: return "string";
				case ot.onnx.TensorProto.DataType.INT64: return "int32";
				case ot.onnx.TensorProto.DataType.UINT64: return "uint32";
				default: throw new Error(`unsupported data type: ${ot.onnx.TensorProto.DataType[e]}`);
			}
		}
		static tensorDataTypeStringToEnum(e) {
			switch (e) {
				case "int8": return ot.onnx.TensorProto.DataType.INT8;
				case "uint8": return ot.onnx.TensorProto.DataType.UINT8;
				case "bool": return ot.onnx.TensorProto.DataType.BOOL;
				case "int16": return ot.onnx.TensorProto.DataType.INT16;
				case "uint16": return ot.onnx.TensorProto.DataType.UINT16;
				case "int32": return ot.onnx.TensorProto.DataType.INT32;
				case "uint32": return ot.onnx.TensorProto.DataType.UINT32;
				case "float32": return ot.onnx.TensorProto.DataType.FLOAT;
				case "float64": return ot.onnx.TensorProto.DataType.DOUBLE;
				case "string": return ot.onnx.TensorProto.DataType.STRING;
				case "int64": return ot.onnx.TensorProto.DataType.INT64;
				case "uint64": return ot.onnx.TensorProto.DataType.UINT64;
		...
		static tensorValueTypeFromProto(e) {
			return {
				...
				shape: { dims: i.tensorDimsFromProto(e.shape.dim.map((o) => o.dimValue)) }
			};
		}
		...
		static adjustPadAndReturnShape(e, o, t, r, n, s, a, u) {
			...
			if (u && u !== "NOTSET") switch (u) {
				case "VALID": return n[s] = 0, n[a] = 0, Math.floor((e - l) / o + 1);
				case "SAME_LOWER":
				case "SAME_UPPER":
...
function hh(i) {
	switch (i) {
		...
		default: throw new Error(`cannot calculate sizeof() on type ${i}`);
	}
}
function Wu(i) {
	switch (i) {
		...
		case H.onnx.TensorProto.DataType.BOOL: return 1;
		case H.onnx.TensorProto.DataType.UINT16:
		case H.onnx.TensorProto.DataType.INT16: return 2;
		case H.onnx.TensorProto.DataType.FLOAT:
		case H.onnx.TensorProto.DataType.INT32:
		case H.onnx.TensorProto.DataType.UINT32: return 4;
		case H.onnx.TensorProto.DataType.INT64:
		case H.onnx.TensorProto.DataType.DOUBLE:
		case H.onnx.TensorProto.DataType.UINT64: return 8;
		default: throw new Error(`cannot calculate sizeof() on type ${H.onnx.TensorProto.DataType[i]}`);
	}
}
function mh(i, e) {
	return new (ju(e))(i);
...
function ju(i) {
	switch (i) {
		...
		default: throw new Error("unspecified error");
	}
}
function ui(i, e) {
...
function Hu(i, e, o) {
	switch (e) {
		...
		case H.onnx.TensorProto.DataType.UINT8: return i.getUint8(o);
		case H.onnx.TensorProto.DataType.INT8: return i.getInt8(o);
		case H.onnx.TensorProto.DataType.UINT16: return i.getUint16(o, !0);
		case H.onnx.TensorProto.DataType.INT16: return i.getInt16(o, !0);
		case H.onnx.TensorProto.DataType.FLOAT: return i.getFloat32(o, !0);
		case H.onnx.TensorProto.DataType.INT32: return i.getInt32(o, !0);
		case H.onnx.TensorProto.DataType.UINT32: return i.getUint32(o, !0);
		case H.onnx.TensorProto.DataType.INT64: return ui(xe.fromBits(i.getUint32(o, !0), i.getUint32(o + 4, !0), !1), e);
		case H.onnx.TensorProto.DataType.DOUBLE: return i.getFloat64(o, !0);
		case H.onnx.TensorProto.DataType.UINT64: return ui(xe.fromBits(i.getUint32(o, !0), i.getUint32(o + 4, !0), !0), e);
		default: throw new Error(`cannot read from DataView for type ${H.onnx.TensorProto.DataType[e]}`);
	}
}
var qu;
var H;
	...
	si = F.experimental.fbs, bt = class i {
		...
		get integerData() {
			switch (this.type) {
				...
				default: throw new TypeError("data type is not integer (uint8, int8, uint16, int16, int32, uint32, bool)");
			}
		}
		get floatData() {
			switch (this.type) {
				...
				default: throw new TypeError("data type is not float (float32, float64)");
			}
		}
		get numberData() {
			...
			if (o === "string") e.stringData.forEach((n, s) => {
				...
				switch (e.dataType) {
					...
					case H.onnx.TensorProto.DataType.UINT64:
						n = e.uint64Data;
						break;
					default: throw new Error("unspecific error");
				}
...
function Oh(i) {
    ...
    ivec3 inputCoordsFromReshapedOutCoords(int index) {
      ${e.map((n, s) => {
		return `${`int ${o[s]} = ${t} / ${n}`}; ${s === e.length - 1 ? `int ${o[s + 1]} = ${t} - ${o[s]} * ${n}` : `index -= ${o[s]} * ${n}`};`;
	}).join("")}
      return ivec3(b, r, c);
    }
  `;
...
var sl = O(() => {
	...
	il = {
		...
		let o = e.dims.length, t = cr("rc", o), r = t.slice(-2), n = Bt(o), s = de(), u = e.dims.length === 0 ? "" : Ph(o, t), l = o <= 1 ? "rc" : `vec2(${r.join(",")})`, p = `
    ${s}
    void main() {
      ${n} rc = getOutputCoords();
       ...
       ${G(i.session.backend.glContext.version).output} = vec4(getChannel(packedInput, ${l}), 0, 0, 0);
     }
   `;
		return {
			...il,
	...
	Dh = (i, e) => {
		...
		getOrCreateTextureData(e, o) {
			...
			if (!t) {
				...
				if (o === 2) {
					let n = pi(this.session.layoutStrategy, e.dims, 1, [], { reverseWH: !0 }), s = this.createTextureData(n, e.type, e.numberData, e, 1);
					t = this.pack(s);
...
var ml = O(() => {
	...
	pl = {
		...
		let e = i.attributes.getFloat("epsilon", 1e-5), o = i.attributes.getFloat("momentum", .9), t = i.attributes.getInt("spatial", 1);
		return W({
			epsilon: e,
			momentum: o,
			spatial: t
...
function he(i) {
	...
	return {
		...
		applyActivation: `value = ${o}_(value);`
	};
}
var pr;
var qe = O(() => {
...
function Lm(i, e, o) {
	let t = e[0].dims, r = e[1].dims, n = kt.calcShape(t, r, !0);
	if (!n) throw new Error("Can't use matmul on the given tensors");
	let s = Bt(n.length), a = ne(), { activationFunction: u, applyActivation: l } = he(o), f = e.length > 2, p = f ? "value += getBiasForMatmul();" : "", d = f ? `${wi(s, a, e[2].dims, n, !1)}` : "", y = n.length, T = t.length, v = r.length, L = `
    ${u}
    ${d}
...
var vi = O(() => {
	...
	km = (i, e) => ({
		...
		let r = o.length > 2, n = r ? "value += getBiasForMatmul();" : "", s = o[0].dims, a = o[1].dims, u = kt.calcShape(s, a, !0), l = !B.areEqual(o[0].dims, o[1].dims);
		if (!u) throw new Error("Can't use matmul on the given tensors");
		let f = s[s.length - 1], p = Math.ceil(f / 2), d = s.length, y = a.length, T = G(i.session.backend.glContext.version), v = Bt(u.length), S = u.length, L = ne(), { activationFunction: P, applyActivation: A } = he(t), M = r ? `${wi(v, L, o[2].dims, u, !0)}` : "", V = l ? `${Fm(v, L, o, u)}` : "", lt = l ? "getAAtOutCoordsMatmul(i)" : `getA(${Cm(L, d)})`, wt = l ? "getBAtOutCoordsMatmul(i)" : `getB(${Nm(L, y)})`, Dt = `
            ${V}
            ${M}
            ${P}
            void main() {
...
var mf = O(() => {
	...
	vi();
	hf = (i, e, o) => {
		let t = e[0].dims, r = e[1].dims, n = dr(t, r, o.dilations, o.pads, o.strides), s = i.run(ff(i, e[0], e[1], n, o), [e[0]]), a = i.reshapePacked(e[1], [r[0], r[1] * r[2] * r[3]]), u = e.length === 3 ? [
			a,
			s,
			e[2]
		] : [a, s], l = i.run(Cn(i, u, o), u);
...
var Bn = O(() => {
	...
	dr = (i, e, o, t, r) => {
		...
		let t = e[0].dims, r = e[1].dims, n = dr(t, r, o.dilations, o.pads, o.strides), s = i.reshapeUnpacked(e[0], [t[1], t[2] * t[3]]), a = i.reshapeUnpacked(e[1], [r[0], r[1]]), u = e.length > 2 ? [
			a,
			s,
			e[2]
		] : [a, s], l = i.run(Ti(u, o), u);
		return i.reshapeUnpacked(l, n);
	}, Wm = (i, e, o) => {
		let t = e[0].dims, r = e[1].dims, n = dr(t, r, o.dilations, o.pads, o.strides), s = i.run(bf(i, e[0], e[1], n, o), [e[0]]), a = e.length === 3 ? [
			s,
			e[1],
			e[2]
		] : [s, e[1]];
		...
		let e = i.attributes, o = pr(e), t = e.getString("auto_pad", "NOTSET"), r = e.getInts("dilations", [1, 1]), n = e.getInt("group", 1), s = e.getInts("kernel_shape", []), a = e.getInts("pads", [
			0,
			0,
			0,
			0
		...
		if (i[0].dims[1] !== i[1].dims[1] * e.group) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
...
var wf = O(() => {
	...
	jm = (i, e, o, t, r, n) => (i - 1) * e + o + (t - 1) * r + 1 - n, Xm = (i, e, o, t, r) => {
		...
		let n = e.length > 2 ? "getB(output_channel)" : "0.0", s = e[0].dims, a = e[1].dims, u = a[1], l = a[0] / t.group, f = [
			...
			e[1].dims[1] * t.group,
			...t.outputShape
		], p = G(i.session.backend.glContext.version), { activationFunction: d, applyActivation: y } = he(t), T = `
  const ivec2 strides = ivec2(${t.strides[0]}, ${t.strides[1]});
  const ivec2 pads = ivec2(${t.pads[0]}, ${t.pads[1]});
  ${d}
  void main() {
...
`;
		...
		let e = i.attributes, o = pr(e), t = e.getString("auto_pad", "NOTSET"), r = e.getInts("dilations", [1, 1]), n = e.getInt("group", 1), s = e.getInts("kernel_shape", []), a = e.getInts("output_padding", [0, 0]), u = e.getInts("output_shape", []), l = e.getInts("pads", [
			0,
			0,
			0,
			0
		...
		if (!i || i.length !== 2 && i.length !== 3) throw new Error("Conv requires 2 or 3 inputs");
		if (i[0].dims.length !== 4 || i[1].dims.length !== 4) throw new Error("currently only support 2-dimensional conv");
		if (i[0].dims[1] !== i[1].dims[0]) throw new Error("FILTER_IN_CHANNEL should be equal to DATA_CHANNEL");
...
var Nn = O(() => {
	...
	vf = {
		...
		cacheHint: o.cacheKey,
		get: () => nb(i, e[0], o.perm)
	}, e)]), If = (i) => W({ perm: i.attributes.getInts("perm", []) }), nb = (i, e, o) => {
		let t = e.dims;
		o = _f(t, o);
...
var kf = O(() => {
	...
	Y();
	j();
	Lf = (i, e, o) => (pb(e, o.axis), [i.run(cb(i, e, o), e)]), $f = (i) => W({ axis: i.attributes.getInt("axis", 0) }), lb = {
		name: "Gather",
		inputNames: ["A", "B"],
		inputTypes: [0, 0]
	}, fb = (i, e, o, t) => {
...
var Nf = O(() => {
	...
	Ai = (i, e, o) => (mb(e, o), [i.run(db(e, o), e)]), Bf = (i, e) => {
		...
		let o = {
			name: "Gemm",
			inputNames: i.length === 3 ? [
				"A",
				"B",
				"C"
			] : ["A", "B"],
			inputTypes: i.length === 3 ? [
				0,
				0,
				0
			] : [0, 0],
...
var Wf = O(() => {
	...
	Vf = (i, e, o) => {
		...
		return [i.run(Ob(i, e[0], o, t.dims), [
			e[0],
			t,
			e[1],
			e[2]
...
function Ab(i, e) {
	let o = i[0].dims[1], t = i[0].dims.length, r = -Math.floor((e.size - 1) / 2), n = Math.ceil((e.size - 1) / 2), s = `float(${e.alpha}) / float(${e.size})`, l = `
    float process(int indices[${t}]) {
        int c = indices[1];
        float x = _X(indices);
...
var Xf = O(() => {
	...
	Hf = (i, e, o) => (Eb(e), [i.run(Pb(e, o), e)]), qf = (i) => {
		let e = i.attributes.getFloat("alpha", 1e-4), o = i.attributes.getFloat("beta", .75), t = i.attributes.getFloat("bias", 1), r = i.attributes.getInt("size");
		return W({
			alpha: e,
			beta: o,
			bias: t,
...
var Zf = O(() => {
	...
	Db = {
      ...
      float process(int[${r}] indices) {
		...
		switch (o.mode) {
			case "constant": return Cb(t, e.dims, s, r, n, o.pads, o.value);
			case "reflect": return Nb(t, e.dims, s, r, n, o.pads);
			case "edge": return Rb(t, e.dims, s, r, n, o.pads);
...
`)}
	...
	}, pc = (i, e, o) => Xe(i, e, o, "ReduceSum", () => [
		"value = 0.0;",
		"value += _A(inputIdx);",
		""
	]), dc = (i, e, o) => Xe(i, e, o, "ReduceMean", (r, n) => {
		let s = 1;
...
value = _A(inputIdx);`,
	...
	}), bc = (i, e, o) => Xe(i, e, o, "ReduceProd", () => [
		"value = 1.0;",
		"value *= _A(inputIdx);",
		""
	]), gc = (i, e, o) => Xe(i, e, o, "ReduceLogSum", () => [
		"value = 0.0;",
		"value += _A(inputIdx);",
		"value = log(value);"
	]), yc = (i, e, o) => Xe(i, e, o, "ReduceLogSumSquare", () => [
		"float t; value = 0.0;",
...
var Li = O(() => {
	...
	vc = {
		...
		let f = i.attributes.getFloat("cubic_coeff_a", -.75), p = i.attributes.getInt("exclude_outside", 0) !== 0;
		if (p && t !== "cubic") throw new Error("exclude_outside can be set to 1 only when mode is CUBIC.");
		let d = e < 11 ? !0 : t === "nearest" && s === "asymmetric" && l === "floor", y = 0, T = 0, v = 0;
	...
	$i = {
		...
		switch (o.coordinateTransformMode) {
			...
			case "align_corners":
                ...
                `;
				break;
			default: throw new Error(`resize (packed) does not support coordinateTransformMode:                                 '${o.coordinateTransformMode}'`);
		}
		let S = Bt(a), P = `
...
var Bc = O(() => {
	...
	Bi = {
      ...
      `)}
		...
		let o = Array.from(e[1].integerData), t = Array.from(e[2].integerData), r = e.length >= 4 ? Array.from(e[3].integerData) : [];
		return {
			starts: o,
			ends: t,
			axes: r,
...
var Wc = O(() => {
	...
	Fc = {
		...
		let n = Zb(i, e[0], t, r, [t]), s = i.run({
			...Fc,
			cacheHint: o.cacheKey,
			get: () => n
		}, e), a = Qb(i, e[0], t, r, n.output.dims, [t]), u = i.run({
			...Cc,
			cacheHint: o.cacheKey,
			get: () => a
		}, [e[0], s]), l = tg(i, e[0], t, r, n.output.dims, a.output.dims);
		return [i.run({
			...Nc,
			cacheHint: o.cacheKey,
			get: () => l
		...
		getPackedOutputSamplingSnippet(o) {
			...
			switch (t.length) {
				...
				case 3:
					...
					break;
				default: n[s] = this.getOutputPackedNDCoords(t, r);
			}
			let u = `
		...
		getUnpackedOutputSamplingSnippet(o) {
			...
			switch (t.length) {
				...
				case 6:
					...
					break;
				default: throw new Error(`Unsupported output dimensionality: ${t.length}`);
			}
			let u = `
      ...
      `;
		...
		getOutputUnpacked3DCoords(o, t) {
			...
			let a = [
				...
				return `${`int ${a[f]} = index / ${l}`}; ${f === s.length - 1 ? `int ${a[f + 1]} = index - ${a[f]} * ${l}` : `index -= ${a[f]} * ${l}`};`;
			}).join("");
			return r = `
        ivec3 getOutputCoords() {
          ivec2 resTexRC = ivec2(TexCoords.xy *
...
`);
      ...
      `;
		...
		getPackedSamplerFromInput(o, t, r) {
			switch (r.unpackedShape.length) {
				case 0: return this.getPackedSamplerScalar(o, t);
				case 1: return this.getPackedSampler1D(o, t, r);
				case 2: return this.getPackedSampler2D(o, t, r);
				case 3: return this.getPackedSampler3D(o, t, r);
				default: return this.getPackedSamplerND(o, t, r);
			}
		}
		getUnpackedSamplerFromInput(o, t, r) {
			let n = r.unpackedShape;
			switch (n.length) {
				case 0: return this.getUnpackedSamplerScalar(o, t, r);
				case 1: return this.getUnpackedSampler1D(o, t, r);
				case 2: return this.getUnpackedSampler2D(o, t, r);
				case 3: return this.getUnpackedSampler3D(o, t, r);
				case 4: return this.getUnpackedSampler4D(o, t, r);
				case 5: return this.getUnpackedSampler5D(o, t, r);
				case 6: return this.getUnpackedSampler6D(o, t, r);
				default: throw new Error(`Unsupported dimension ${n.length}-D`);
			}
		}
		getPackedSamplerScalar(o, t) {
			let n = `
          vec4 ${o}() {
            return ${G(this.context.glContext.version).texture2D}(${t}, halfCR);
          }
        `;
			return new k(n);
		}
      ...
      return ${a.texture2D}(${t}, uv);
		...
		getPackedSampler3D(o, t, r) {
			...
			if (n[0] === 1) {
				let v = n.slice(1), S = [1, 2], L = lr(n, v), P = [
					"b",
					"row",
					"col"
      ...
      vec4 ${o}(int b, int row, int col) {
        return ${o}(${fr(P, S)});
			...
			let l = a[0], f = a[1], p = Math.ceil(n[2] / 2), T = `vec4 ${o}(int b, int row, int col) {
      ...
      `;
		...
		getUnpackedSampler4D(o, t, r) {
			let n = r.unpackedShape, s = n[3], a = n[2] * s, p = `
	...
	zn = class i extends Ht {
      ...
      highp vec4 encode(highp float f) {
		...
		static isLittleEndian() {
			let e = /* @__PURE__ */ new ArrayBuffer(4), o = new Uint32Array(e), t = new Uint8Array(e);
			...
			for (let { name: s, type: a, location: u, arrayLength: l } of e) {
				...
				switch (a) {
					...
					case "int":
						...
						break;
					default: throw new Error(`Uniform not implemented: ${a}`);
				}
			}
		}
		bindTexture(e, o, t) {
...
var xp = O(() => {
	...
	Kn = class {
		...
		toTensorData(e, o) {
			switch (e) {
				case "int16": return o instanceof Int16Array ? o : Int16Array.from(o);
				case "int32": return o instanceof Int32Array ? o : Int32Array.from(o);
				case "int8": return o instanceof Int8Array ? o : Int8Array.from(o);
				case "uint16": return o instanceof Uint16Array ? o : Uint16Array.from(o);
				case "uint32": return o instanceof Uint32Array ? o : Uint32Array.from(o);
				case "uint8":
				case "bool": return o instanceof Uint8Array ? o : Uint8Array.from(o);
				case "float32": return o instanceof Float32Array ? o : Float32Array.from(o);
				case "float64": return o instanceof Float64Array ? o : Float64Array.from(o);
				default: throw new Error(`TensorData type ${e} is not supported`);
			}
		}
		toTextureData(e, o) {
...
${e}`);
			...
			if (z.debug) {
				...
				switch (o) {
					...
					case e.CONTEXT_LOST_WEBGL:
						...
						break;
					default: t = `Unknown WebGL Error: ${o.toString(16)}`;
				}
				throw new Error(t);
			}
		}
		...
		getEncoder(e, o, t = 0) {
			...
			switch (e) {
				case "float": return t === 1 || this.isRenderFloat32Supported ? new Br(this.gl, o) : new Br(this.gl, o, this.textureHalfFloatExtension.HALF_FLOAT_OES);
				case "int": throw new Error("not implemented");
				case "byte": return new En(this.gl, o);
				default: throw new Error(`Invalid dataType: ${e}`);
			}
		}
		clearActiveTextures() {
			let e = this.gl;
...
var _p = O(() => {
	...
	Yn = class {
		...
		initialize() {
			try {
				return this.glContext = Gi(this.contextId), typeof this.matmulMaxBatchSize != "number" && (this.matmulMaxBatchSize = 16), typeof this.textureCacheMode != "string" && (this.textureCacheMode = "full"), typeof this.pack != "boolean" && (this.pack = !1), typeof this.async != "boolean" && (this.async = !1), tt.setWithEnv(z), z.webgl.context || Object.defineProperty(z.webgl, "context", { value: this.glContext.gl }), tt.verbose("WebGLBackend", `Created WebGLContext: ${typeof this.glContext} with matmulMaxBatchSize: ${this.matmulMaxBatchSize}; textureCacheMode: ${this.textureCacheMode}; pack: ${this.pack}; async: ${this.async}.`), !0;
			} catch (e) {
...
var Pp = O(() => {
	...
	Xt = F.experimental.fbs, Ur = class i {
		...
		static getType(e) {
			...
			switch (o) {
				case q.onnx.AttributeProto.AttributeType.FLOAT: return "float";
				case q.onnx.AttributeProto.AttributeType.INT: return "int";
				case q.onnx.AttributeProto.AttributeType.STRING: return "string";
				case q.onnx.AttributeProto.AttributeType.TENSOR: return "tensor";
				case q.onnx.AttributeProto.AttributeType.FLOATS: return "floats";
				case q.onnx.AttributeProto.AttributeType.INTS: return "ints";
				case q.onnx.AttributeProto.AttributeType.STRINGS: return "strings";
				case q.onnx.AttributeProto.AttributeType.TENSORS: return "tensors";
				default: throw new Error(`attribute type is not supported yet: ${q.onnx.AttributeProto.AttributeType[o]}`);
			}
		}
		static getValue(e) {
			let o = e instanceof q.onnx.AttributeProto ? e.type : e.type();
		...
		static getValueNoCheckFromOnnxFormat(e) {
			switch (e.type) {
				case q.onnx.AttributeProto.AttributeType.FLOAT: return e.f;
				case q.onnx.AttributeProto.AttributeType.INT: return e.i;
				case q.onnx.AttributeProto.AttributeType.STRING: return e.s;
				case q.onnx.AttributeProto.AttributeType.TENSOR: return e.t;
				case q.onnx.AttributeProto.AttributeType.GRAPH: return e.g;
				case q.onnx.AttributeProto.AttributeType.FLOATS: return e.floats;
				case q.onnx.AttributeProto.AttributeType.INTS: return e.ints;
				case q.onnx.AttributeProto.AttributeType.STRINGS: return e.strings;
				case q.onnx.AttributeProto.AttributeType.TENSORS: return e.tensors;
				case q.onnx.AttributeProto.AttributeType.GRAPHS: return e.graphs;
				default: throw new Error(`unsupported attribute type: ${q.onnx.AttributeProto.AttributeType[e.type]}`);
			}
		}
		static getValueNoCheckFromOrtFormat(e) {
			switch (e.type()) {
				case Xt.AttributeType.FLOAT: return e.f();
				case Xt.AttributeType.INT: return e.i();
				case Xt.AttributeType.STRING: return e.s();
				case Xt.AttributeType.TENSOR: return e.t();
				case Xt.AttributeType.GRAPH: return e.g();
				case Xt.AttributeType.FLOATS: return e.floatsArray();
				...
				default: throw new Error(`unsupported attribute type: ${Xt.AttributeType[e.type()]}`);
			}
		}
	};
});
	...
	vg = F.experimental.fbs, eo = class {
		...
		load(e, o, t) {
			...
			try {
				...
				throw t !== void 0 ? n : /* @__PURE__ */ new Error(`Failed to load model as ONNX format: ${r}
as ORT format: ${n}`);
			}
		}
	...
	Np && (self.onmessage = (i) => {
		...
		try {
			switch (e) {
				...
				case "end-profiling": co(o), postMessage({ type: e });
			}
		} catch (t) {
			postMessage({
				type: e,
...
var Vp = O(() => {
	...
	Mp = (ji = import.meta.url, async function(i = {}) {
		...
		var y, T, v = globalThis.SharedArrayBuffer ?? new WebAssembly.Memory({
			initial: 0,
			maximum: 0,
			shared: !0
		}).buffer.constructor, S = Object.assign({}, u), L = "./this.program", P = (c, m) => {
			throw m;
		}, A = "";
		...
		var C, Kr, we, oe, be, Z, ge, ie, ae, se = !1;
		function it() {
			var c = C.buffer;
		...
		var sa = (c) => new Promise((m) => {
			c.onmessage = (I) => {
				...
				} else E === "checkMailbox" ? tn() : E === "spawnThread" ? ra(I) : E === "cleanupThread" ? ia(fe[I.thread]) : E === "killThread" ? (I = I.thread, E = fe[I], delete fe[I], _o(E), ko(I), Le.splice(Le.indexOf(E), 1), E.Ra = 0) : E === "cancelThread" ? fe[I.thread].postMessage({ cmd: "cancel" }) : E === "loaded" ? (c.loaded = !0, m(c)) : E === "alert" ? alert(`Thread ${I.threadId}: ${I.text}`) : I.target === "setimmediate" ? c.postMessage(I) : E === "callHandler" ? u[I.handler](...I.args) : E && et(`worker sent an unknown command ${E}`);
			}, c.onerror = (I) => {
		...
		function Od(c) {}
		function Sd(c, m) {
			c = -9007199254740992 > c || 9007199254740992 < c ? NaN : Number(c), m >>>= 0, c = /* @__PURE__ */ new Date(1e3 * c), t()[m >>> 2 >>> 0] = c.getUTCSeconds(), t()[m + 4 >>> 2 >>> 0] = c.getUTCMinutes(), t()[m + 8 >>> 2 >>> 0] = c.getUTCHours(), t()[m + 12 >>> 2 >>> 0] = c.getUTCDate(), t()[m + 16 >>> 2 >>> 0] = c.getUTCMonth(), t()[m + 20 >>> 2 >>> 0] = c.getUTCFullYear() - 1900, t()[m + 24 >>> 2 >>> 0] = c.getUTCDay(), c = (c.getTime() - Date.UTC(c.getUTCFullYear(), 0, 1, 0, 0, 0, 0)) / 864e5 | 0, t()[m + 28 >>> 2 >>> 0] = c;
		}
		var Qe = (c) => c % 4 == 0 && (c % 100 != 0 || c % 400 == 0), Ea = [
			0,
			31,
			60,
			91,
		...
		function Ad(c, m) {
			c = -9007199254740992 > c || 9007199254740992 < c ? NaN : Number(c), m >>>= 0, c = /* @__PURE__ */ new Date(1e3 * c), t()[m >>> 2 >>> 0] = c.getSeconds(), t()[m + 4 >>> 2 >>> 0] = c.getMinutes(), t()[m + 8 >>> 2 >>> 0] = c.getHours(), t()[m + 12 >>> 2 >>> 0] = c.getDate(), t()[m + 16 >>> 2 >>> 0] = c.getMonth(), t()[m + 20 >>> 2 >>> 0] = c.getFullYear() - 1900, t()[m + 24 >>> 2 >>> 0] = c.getDay();
...
`))[0] == "Error" && x.shift(), Ba(x);
		...
		function Wa(c, m, g, x) {
			...
			function at(_) {
				switch (_.getDay()) {
					case 0: return new Date(_.getFullYear() - 1, 11, 29);
					case 1: return _;
					case 2: return new Date(_.getFullYear(), 0, 3);
					case 3: return new Date(_.getFullYear(), 0, 2);
					case 4: return new Date(_.getFullYear(), 0, 1);
					case 5: return new Date(_.getFullYear() - 1, 11, 31);
					case 6: return new Date(_.getFullYear() - 1, 11, 30);
				}
			}
			function Pt(_) {
				var Q = _.Sa;
...
`,
		...
		var Wd = [
			...
			return ve ||= u.locateFile ? gt("ort-wasm-simd-threaded.wasm") ? "ort-wasm-simd-threaded.wasm" : u.locateFile ? u.locateFile("ort-wasm-simd-threaded.wasm", A) : A + "ort-wasm-simd-threaded.wasm" : new URL("../../onnxruntime-web/dist/ort-wasm-simd-threaded.wasm", import.meta.url).href, function(g, x) {
				var I = ve;
...
var Vr = O(() => {
	"use strict";
	oo();
	br = import.meta.url ?? (typeof document < "u" ? document.currentScript?.src : typeof self < "u" ? self.location?.href : void 0), Sg = typeof location > "u" ? void 0 : location.origin, Ag = (i, e) => {
		try {
			let o = e ?? br;
...
var Ke = O(() => {
	...
	Ki = !1, ho = !1, qp = !1, Dg = () => {
		...
		let r = i.wasmPaths, n = typeof r == "string" ? r : void 0, s = r?.mjs, a = s?.href ?? s, u = r?.wasm, l = u?.href ?? u, f = i.wasmBinary, [p, d] = await Hp(a, n, o > 1), y = !1, T = [];
...
var Jp = O(() => {
	...
	$g = (i) => {
		switch (i) {
			...
			case "all": return 99;
			default: throw new Error(`unsupported graph optimization level: ${i}`);
		}
	}, kg = (i) => {
		switch (i) {
			case "sequential": return 0;
			case "parallel": return 1;
			default: throw new Error(`unsupported execution mode: ${i}`);
		}
	}, Bg = (i) => {
...
var Ji = O(() => {
	...
	Hr = (i) => {
		switch (i) {
			...
			default: throw new Error(`unsupported data type: ${i}`);
		}
	}, Yp = (i) => {
		switch (i) {
			case 3: return "int8";
		...
		let o = [
			...
			.5,
			.5
		][i], t = typeof e == "number" ? e : e.reduce((r, n) => r * n, 1);
		...
		switch (i) {
			...
			case "error": return 3;
			case "fatal": return 4;
			default: throw new Error(`unsupported logging level: ${i}`);
		}
		...
		switch (i) {
			...
			default: throw new Error(`unsupported data location: ${i}`);
		}
	};
});
var jr;
...
var qi = O(() => {
	...
	Cg = (i, e) => {
	...
	}, so = async (i, e) => {}, yr = /* @__PURE__ */ new Map(), Ng = (i) => {
		let e = xt(), o = e.stackSave();
		try {
			let t = e.stackAlloc(8);
		...
		try {
			...
			throw l.forEach((d) => r._OrtFree(d)), f.forEach((d) => r._OrtFree(d)), n !== 0 && r._OrtReleaseSession(n), p;
		} finally {
		...
		try {
			...
			for (let Z = 0; Z < v; Z++) {
				...
				let ie = s.stackSave(), ae = s.stackAlloc(16), se = !1, it, Lt = 0;
				try {
					...
					if (it === "string") {
						...
						let Ot = new (Zp(it))(Mt);
						new Uint8Array(Ot.buffer, Ot.byteOffset, Ot.byteLength).set(s.HEAPU8.subarray(Lt, Lt + Ot.byteLength)), be.push([
							it,
							le,
							Ot,
							"cpu"
			...
			return p && !d && (s._OrtClearBoundOutputs(p.handle), yr.set(i, [
				u,
				l,
				f,
				p,
...
var ta = O(() => {
	...
	Ke();
	Vr();
	Je = () => !!z.wasm.proxy && typeof document < "u", Xr = !1, xo = !1, To = !1, Qi = /* @__PURE__ */ new Map(), xr = (i, e) => {
		let o = Qi.get(i);
...
var fd = O(() => {
	...
	ld = (i, e) => {
		switch (i.location) {
			...
			default: throw new Error(`invalid data location: ${i.location} for ${e()}`);
		}
	}, Mg = (i) => {
		switch (i[3]) {
			case "cpu": return new yt(i[0], i[2], i[1]);
			case "gpu-buffer": {
				let e = i[0];
			...
			default: throw new Error(`invalid data location: ${i[3]}`);
		}
	}, wo = class {
		...
		async loadModel(e, o) {
			Fe();
			let t;
			typeof e == "string" ? t = await this.fetchModelAndCopyToWasmMemory(e) : t = e, [this.sessionId, this.inputNames, this.outputNames] = await id(t, o), Ce();
		}
		async dispose() {
